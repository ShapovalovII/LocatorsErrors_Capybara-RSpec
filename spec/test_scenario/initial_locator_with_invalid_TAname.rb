...
feature 'Verification of information output the locators errors.' do
  scenario 'Initial locator with invalid TA name' do
    ...
    expError = 'TrueAutomation locator name contains unsupported characters. Please make sure to use only letters, numbers, colon and underscore symbols in locator names'
